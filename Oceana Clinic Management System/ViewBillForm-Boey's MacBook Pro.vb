...
Public Class ViewBillForm
    ...
    Private Sub btnCalculateTotalAmount_Click(sender As Object, e As EventArgs) Handles btnCalculateTotalAmount.Click
        ...
        If chkOneMedicineType.Checked = True And txtOneMedicineType.Text = "" Then
            MsgBox("Please fill in the number of medicine type", MessageBoxIcon.Warning, "Warning")
    ...
    Private Sub btnCalculateChangeAmount_Click(sender As Object, e As EventArgs) Handles btnCalculateChangeAmount.Click
        ...
        If txtReceivedAmount.Text = "" Then
            MsgBox("Please fill in the received amount", MessageBoxIcon.Warning, "Error")
    ...
    Private Sub btnClearAll_Click(sender As Object, e As EventArgs) Handles btnClearAll.Click
        ...
        Select Case MsgBox("Are you sure?", MsgBoxStyle.YesNo, "Clear All Result")
            Case MsgBoxResult.Yes
                If vbYes Then
                    MsgBox("All details are cleared", MessageBoxIcon.Information, "Details Cleared")
                    txtPatientID.Text = ""
                    txtName.Text = ""
                    txtTotalConsultationFee.Text = ""
                    txtTotalMedicationFee.Text = ""
    ...
    Private Sub btnGenerateReceipt_Click(sender As Object, e As EventArgs) Handles btnGenerateReceipt.Click
        ...
        rtfReceipt.AppendText("Total Service Fee :" + vbTab + vbTab + "RM" + txtTotalServiceFee.Text + vbNewLine)
        rtfReceipt.AppendText("" + vbNewLine)
        rtfReceipt.AppendText("" + vbNewLine)
