...
Public Class UserAccountForm
    ...
    Private Sub btnCreateNewAccount_Click(sender As Object, e As EventArgs) Handles btnCreateNewAccount.Click
        ...
        Try
            If txtUserID.Text = "" Or txtPassword.Text = "" Or cboUserType.SelectedItem = String.Empty Then
                MsgBox("Please fill in all details", MessageBoxIcon.Warning, "Create Failed")
            Else
                command.ExecuteNonQuery()
    ...
    Private Sub btnChangePassword_Click(sender As Object, e As EventArgs) Handles btnChangePassword.Click
        ...
        If txtUserID.Text = "" Or txtPassword.Text = "" Then
            MsgBox("Please fill in User ID and new password to change password", MessageBoxIcon.Warning, "Change Failed")
            txtUserID.Focus()
        Else
            Select Case MessageBox.Show("Are You Sure?", "Change Password", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
    ...
    Private Sub btnDeleteUser_Click(sender As Object, e As EventArgs) Handles btnDeleteUser.Click
        ...
        If txtUserID.Text = "" Then
            MsgBox("Please fill in User ID", MessageBoxIcon.Warning, "Delete Failed")
            txtUserID.Focus()
        Else
